...
from citylearn.reward_function import IndependentSACReward #try solar penalty if this doesn't work
...
JOBS = 1
DIRECTION = 'maximize'
SAVE_DIR = 'C:/Users/Broda-Milian/OneDrive - rmc-cmr.ca/Documents/CityLearn Examples/optuna/continuous PPO/sac reward models' + '/'
...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = [trial.suggest_int("layer_0_units", 64, 512, step=16),
                trial.suggest_int("layer_1_units", 64, 512, step=16)]
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(sampler=TPESampler(n_startup_trials=N_STARTUP_TRIALS), #TPE suggested for uncorrelated hyperparamenters and less than 1000 trials
                                ...
                                direction=DIRECTION, 
                                storage=rdb, 
                                study_name='Continuous PPO SAC reward',
    ...
    env_kwargs = dict(
        reward_function = IndependentSACReward, #possible issue with utils make cont env function prevented this reward from being applied...
    )
