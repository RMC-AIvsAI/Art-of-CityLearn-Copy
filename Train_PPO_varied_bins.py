...
T = env.time_steps - 1
agent_name = f'default_PPO_{dataset_name}_{building}_{bins}_bins'
...
agent_name = f'default_PPO_{dataset_name}_{building}_{bins}_bins_{int(eval_callback.num_timesteps/T)}'
